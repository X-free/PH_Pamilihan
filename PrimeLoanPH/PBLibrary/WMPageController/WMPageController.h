 ...
 */
- (WMMenuItem *)menuView_initialMenuItem:(WMMenuItem *)initialMenuItem atIndex:(NSInteger)index;
@end

@interface WMPageController : PPBaseViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
