...
//    NSLog(@"frame:%@ %@ %@ %@", NSStringFromCGRect(frame), NSStringFromCGRect(self.leftView.frame), NSStringFromCGRect(self.scrollView.frame), NSStringFromCGRect(self.rightView.frame));
