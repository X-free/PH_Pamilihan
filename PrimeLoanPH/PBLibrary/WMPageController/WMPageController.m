...
- (WMMenuItem *)menuView:(WMMenuView *)menu initialMenuItem:(WMMenuItem *)initialMenuItem atIndex:(NSInteger)index{
    if ([self.delegate respondsToSelector:@selector(menuView_initialMenuItem:atIndex:)]) {
      return [self.delegate menuView_initialMenuItem:initialMenuItem atIndex:index];
    }else{
